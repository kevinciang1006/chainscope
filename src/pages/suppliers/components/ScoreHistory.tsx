...
export function ScoreHistory({ history }: ScoreHistoryProps) {
  const data: ChartPoint[] = history.slice(-12).map((pt) => ({
  ...
  return (
    <figure>
      <figcaption className="sr-only">
        12-month ESG score history showing Environmental, Social, and Governance subscores.
      </figcaption>
      ...
      {/* Manual legend */}
      <ul className="flex items-center gap-4 text-xs text-text-2 mt-2" aria-hidden="true">
